...
img1_bgr = cv2.imread('res\\AA9_mut_e13_6dpf_bf.png', cv2.IMREAD_COLOR)
img1_gs = cv2.cvtColor(img1_bgr, cv2.COLOR_BGR2GRAY)
img2_bgr = cv2.imread('res\\AA9_mut_e13_6dpf_bire.png', cv2.IMREAD_COLOR)
img2_gs = cv2.cvtColor(img2_bgr, cv2.COLOR_BGR2GRAY)

ret, thresh = cv2.threshold(img2_gs,45,255,cv2.THRESH_BINARY+cv2.THRESH_OTSU)
